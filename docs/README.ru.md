...
Подробнее: [правила выбора глубины](./depth-levels.md) и [контракт результата](./outputs.md).
...
Подробности: [модель доказательств](../core/skill/map-project/references/evidence-model.md), [SECURITY.md](../SECURITY.md) и [методология](./methodology.md).
...
Точные технические лимиты описаны в [протоколе](../core/PROTOCOL.md) и [документации двух версий](./adapters.md).
